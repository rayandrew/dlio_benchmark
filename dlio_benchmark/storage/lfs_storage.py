...
class LFSStorage(DataStorage):
    ...
    def __init__(self, namespace, framework=None):
        ...
        liblustre = ctypes.util.find_library("lustreapi")
        self.lustre = ctypes.CDLL(liblustre, use_errno=True)

    @dlp.log
    def setstripe(self, filename: str, stripesize=0, stripeoffset=-1, stripecount=1):
        ...
        rc = self.lustre.llapi_file_create_pool(filename.encode(), stripesize, stripeoffset, stripecount, 0, None)
    ...
    def create_namespace(self, exist_ok=False):
        ...
        # self.setstripe(self.namespace.name, stripecount=-1)
        return True
    ...
    def create_node(self, id, exist_ok=False):
        ...
        self.setstripe(self.get_uri(id), stripecount=-1)
        return True
